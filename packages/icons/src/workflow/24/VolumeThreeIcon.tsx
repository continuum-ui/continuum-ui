    ...
    ({ className, size, focusable = false, hidden = true, color = "currentColor", ...props }, forwardedRef) => {
        return (
            ...
            >
                ...
                <path d="m37.625 5.771-.16.187a1.827 1.827 0 0 0-.437 1.07 1.715 1.715 0 0 0 .5 1.336 22 22 0 0 1 0 31.272 1.7 1.7 0 0 0-.5 1.184 1.828 1.828 0 0 0 .44 1.222l.16.187a1.766 1.766 0 0 0 1.134.609A1.863 1.863 0 0 0 40.3 42.3a25.835 25.835 0 0 0 0-36.6 1.862 1.862 0 0 0-1.567-.537 1.76 1.76 0 0 0-1.108.608Z" />
            </svg>
        );
    },
);
