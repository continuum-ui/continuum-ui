    ...
    ({ className, size, focusable = false, hidden = true, color = "currentColor", ...props }, forwardedRef) => {
        return (
            <svg
                ...
                ref={forwardedRef}
            >
                <path d="M24.313 17.11a.5.5 0 0 0-.626 0l-5.451 5.524a.785.785 0 0 0-.236.56.8.8 0 0 0 .8.806H22v19a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V24h3.2a.8.8 0 0 0 .8-.806.785.785 0 0 0-.236-.56Z" />
